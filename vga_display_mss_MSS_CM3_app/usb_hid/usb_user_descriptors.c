 ...
 *
 * USB HID Class Mouse Device Example application to demonstrate the SmartFusion2
...
#define  USB_STRING_PRODUCT                                 "MSCC_UsbHID"//Modified
...
uint8_t device_descriptor[USB_STD_DEVICE_DESCR_LEN] =
{
    ...
    0x14u,                                              /* idVendor LSB */
    0x15u,                                              /* idVendor MSB */
    0x15u,                                              /* idProduct LSB */ //Modified
    0x20u,                                              /* idProduct MSB */ //Modified
    0x00u,                                              /* bcdDevice LSB */
    0x30u,                                              /* bcdDevice MSB */
